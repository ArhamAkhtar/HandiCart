...
<hr style="width: 100%">
<form action="addressPaymentForOrderBTS.jsp" method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
<input class="input-style" type="text" name="address" value="<%=rs2.getString(7)%>" placeholder="Enter your address" required></div>
<div class="right-div">
<h3>Enter city</h3>
<input class="input-style" type="text" name="City" value="<%=rs2.getString(8)%>" placeholder="Enter your city" required></div> 
<div class="left-div">
<h3>Enter State</h3>
 <input class="input-style" type="text" name="State" value="<%=rs2.getString(9)%>" placeholder="Enter your state" required></div>
 <div class="right-div">
<h3>Enter country</h3>
...
<div class="right-div">
<h3>Pay online on Handicart</h3>
 <input class="input-style" type="text" name="Transaction_ID" placeholder="Enter Transaction ID" required>
