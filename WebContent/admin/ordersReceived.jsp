...
if("cancel".equals(prompt))
{
%>
<h3 class="alert">Order Cancelled Successfully!</h3>
<%} %>
<% 
if("delivered".equals(prompt))
{
%>
            ...
            <td><i class="fa fa-inr"></i> <%=rs.getString(5) %> </td>
             ...
             <td><%=rs.getString(11) %></td>
              <td><%=rs.getString(12) %></td>
               ...
               <td><a href="cancelOrdersBTS.jsp?id=<%=rs.getString(2) %>&email=<%=rs.getString(1) %>">Cancel <i class='fas fa-window-close'></i></a></td>
                <td><a href="deliveredOrdersBTS.jsp?id=<%=rs.getString(2) %>&email=<%=rs.getString(1) %>">Delivered <i class='fas fa-dolly'></i></a></td>
            </tr>
		<%}
