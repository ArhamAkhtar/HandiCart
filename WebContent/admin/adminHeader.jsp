...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <div class="topnav sticky">
            ...
            <center> <h2>Handicart</h2></center>
            <a href="addNewProduct2.jsp">Add New Product <i class='fas fa-plus-square'></i></a>
            <a href="allProductsView.jsp">All Products & Edit Products <i class='fab fa-elementor'></i></a>
